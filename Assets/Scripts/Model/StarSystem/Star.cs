...
public class Star : CelestialBody
{
    ...
    public Star(Game game, StarOrbit starOrbit, string name) : base(CelestialBodyType.Star, starOrbit, game)
    {
        ...
        switch(GameDataHolder.r.Next() % 5)
        {
            case 0:
                yields.Add(new CelestialBodyYield((GlobalResourceType.Physics, GameDataHolder.r.Next() % 3 + 2), this));
                break;
            case 1:
                yields.Add(new CelestialBodyYield((GlobalResourceType.Engineering, GameDataHolder.r.Next() % 3 + 2), this));
                break;
            default:
        ...
        int typeDecider = GameDataHolder.r.Next() % 100;
        if (typeDecider < 3)
        {
            starType = StarType.O;
            orbitNum = GameDataHolder.r.Next() % 5 + 4;
        ...
        {
            starType = StarType.B;
            orbitNum = GameDataHolder.r.Next() % 4 + 4;
            inhabitableChance = 0.1f;
        ...
        {
            starType = StarType.F;
            orbitNum = GameDataHolder.r.Next() % 3 + 4;
        ...
        {
            starType = StarType.G;
            orbitNum = GameDataHolder.r.Next() % 4 + 3;
            inhabitableChance = 0.2f;
            inhabitableRange = (3, 5);
        }
        ...
        {
            starType = StarType.K;
            orbitNum = GameDataHolder.r.Next() % 3 + 3;
            inhabitableChance = 0.2f;
        ...
        {
            starType = StarType.M;
            orbitNum = GameDataHolder.r.Next() % 4 + 2;
            inhabitableChance = 0.2f;
            inhabitableRange = (3, 5);
        }
        else if (typeDecider < 84)
        {
            ...
            orbitNum = GameDataHolder.r.Next() % 5 + 5;
            inhabitableChance = 0.15f;
        ...
        else if (typeDecider < 89)
        {
            ...
            orbitNum = GameDataHolder.r.Next() % 3 + 2;
            inhabitableChance = 0;
        ...
        else if (typeDecider < 100)
        {
            ...
            orbitNum = GameDataHolder.r.Next() % 3 + 1;
            inhabitableChance = 0;
            inhabitableRange = (0, 0);
        }
    }
