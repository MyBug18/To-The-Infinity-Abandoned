...
public class PPC_ColorPicker_H : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
{
    ...
    {
        if (mouseDown)
            colorPicker.CalculateColor(rectTrans, PPC_ColorPicker.ColorComponent.H);
    }
